...
const features = [
  ...
  {
    title: "Customizable",
    description: "Customize Rayo to fit your needs and preferences.",
    icon: "icon-2",
  },
  {
    title: "Analytics",
  ...
  {
    title: "Secure",
    description: "Your data is safe and secure with Rayo.",
  },
  {
    title: "Scalable",
    description: "Grow your business with Rayo as you scale.",
  },
  {
    title: "Fast Support",
